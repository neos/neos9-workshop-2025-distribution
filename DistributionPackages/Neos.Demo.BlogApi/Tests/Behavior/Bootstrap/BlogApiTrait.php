...
trait BlogApiTrait
{
    private ResponseInterface|null $blog_api_query_response = null;
    ...
    public function iIssueTheFollowingQuery(string $path, TableNode $payload): void
    {
        ...
        $this->blog_api_query_response = $this->getObject(Context::class)->withoutAuthorizationChecks(
    ...
    {
        $contents = $this->blog_api_query_response?->getBody()->getContents();
